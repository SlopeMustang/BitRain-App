...
> **처음 열 때 한 단계가 더 필요합니다.** 아직 Apple 공증을 거치지 않아 「확인되지 않은 개발자」로 막힙니다. 실행 → 차단 경고에서 **「완료」** → **시스템 설정 › 개인정보 보호 및 보안** 에서 **「확인 없이 열기」** 를 누르십시오. 처음 한 번만 하면 됩니다. (macOS 15부터는 우클릭 → 열기로 넘어가지 않습니다.)
